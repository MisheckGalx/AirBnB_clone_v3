#!/usr/bin/python3
'''
Defines a class Database Storage
'''
...
class DBStorage:
    '''
        Class for SQLalchemy database Storage
    '''
    __engine = None
    __session = None
    ...
    def save(self):
        '''Commit/Save all changes of the database session'''
    ...
    def reload(self):
        '''Reload all changes of current database session'''
